import unittest
from rigelcore.simulations import AssessmentStrategy, SingleMatchAssessmentStrategy
from rigelcore.simulations.strategy import (
    assess_condition,
    assess_different,
    assess_equal,
    assess_greater,
...
class AssessmentOperationsTesting(unittest.TestCase):
    """
    Test suite for all isolated functions declared within rigelcore.simulations.strategy.py
    """
    ...
    @patch('rigelcore.simulations.strategy.assess_equal')
    ...
    @patch('rigelcore.simulations.strategy.assess_different')
    ...
    @patch('rigelcore.simulations.strategy.assess_lesser')
    ...
    @patch('rigelcore.simulations.strategy.assess_lesser_than')
    ...
    @patch('rigelcore.simulations.strategy.assess_greater')
    ...
    @patch('rigelcore.simulations.strategy.assess_greater_than')
...
class AssessmentStrategyTesting(unittest.TestCase):
    """
    Test suite for rigelcore.simulations.AssessmentStrategy class.
    """
...
class SingleMatchAssessmentStrategyTesting(unittest.TestCase):
    """
    Test suite for rigelcore.simulations.SingleMatchAssessmentStrategy class.
    """

    @patch('rigelcore.simulations.strategy.assess_condition')
