...
class SimulationRequirementTesting(unittest.TestCase):
    """
    Test suite for rigelcore.simulations.SimulationRequirement class.
    """
...
class SimpleSimulationRequirementTesting(unittest.TestCase):
    """
    Test suite for rigelcore.simulations.SimpleSimulationRequirement class.
    """
    ...
    @patch('rigelcore.simulations.requirement.SingleMatchAssessmentStrategy')
